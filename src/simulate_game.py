...
def simulate_30_times(label_name,total, target_recall = 0.7, thres = 10):
            ...
            if pos < 1:
                ...
                if pos <= thres:
                    ...
                    for id in certain:
                        read.code(id, read.body["label"][id])
        read.count = count
        save_pickle(all_simulation, 'all_simulation_' + label_name, '/Users/wwang33/Documents/IJAIED20/src/workspace/data/game_labels_'+str(total), 'simulation_'+ str(thres) +"_"+ str(target_recall))
...
if __name__ == "__main__":
    ...
    for label_name in label_name_s:
        simulate_30_times(label_name,total, target_recall, thres)
